    ...
    if (ValidarCamposRequeridos(_form)) {
        ...
        var options = {
            success: function (data) {
                ...
                {
                    window.location.href = RootURL + 'Funcionario/IndexFuncionario';
                }  
            },
...
function CrearInformeReporte() {
    ...
    var DatosNewSolicitud = {
        ...
        HorasDeReparacion: $('#HorasDeReparacion').val(),
        EstadoBache: $('#EstadoBache').val(),
        CantRelleno: $('#CantRelleno').val(),
        CostoBache: $('#CostoBache').val(),
        IdBache: $('#IdBache').val()
    }

    $.ajax({
        url: RootURL + "Funcionario/CrearInforme",
        type: "Post",
        cache: true,
        data: DatosNewSolicitud,
        success: function (data) {
